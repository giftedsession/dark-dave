...
CFonts.say('𝐃𝐀𝐕𝐄-𝐗𝐌𝐃', {
  ...
  maxLength: '0',             // Panjang maksimal teks (0 untuk tidak dibatasi)
            ...
            console.log(color(`${global.themeemoji} GITHUB: giftedsession`,'magenta'))
            console.log(color(`${global.themeemoji} INSTAGRAM: _gifted_dave`,'magenta'))
            console.log(color(`${global.themeemoji} WA NUMBER: ${global.owner}`,'magenta'))
            console.log(color(`${global.themeemoji} RECODE: 𝐃𝐀𝐕𝐄-𝐗𝐌𝐃
            await delay(1000 * 2) 
            Gifted.groupAcceptInvite("https://chat.whatsapp.com/FCwOCmmS3unCOA5w0ehWfC?mode=r_t")*/
...
return waMessage
    ...
    Gifted.sendPoll = (jid, name = '', values = [], selectableCount = 1) => { return Gifted.sendMessage(jid, { poll: { name, values, selectableCount }}) }
